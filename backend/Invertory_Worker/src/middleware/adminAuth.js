...
// Only allows service binding for initial stock creation (POST /stock/:sku_id)
 ...
 * This is used for all admin endpoints EXCEPT initial stock creation
 */
...
/**
 * Require service binding OR admin JWT for initial stock creation
 * This allows Catalog Worker to create stock via service binding
 * OR allows admin to manually initialize stock via JWT
 */
