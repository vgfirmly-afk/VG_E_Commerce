...
export function validateSkuStock(data) {
  return skuStockSchema.validate(data, {
    abortEarly: false,
    stripUnknown: true,
  });
}
...
export function validateStockAdjustment(data) {
  return stockAdjustmentSchema.validate(data, {
    abortEarly: false,
    stripUnknown: true,
  });
}
...
export function validateReserveStock(data) {
  return reserveStockSchema.validate(data, {
    abortEarly: false,
    stripUnknown: true,
  });
}
...
export function validateReleaseStock(data) {
  return releaseStockSchema.validate(data, {
    abortEarly: false,
    stripUnknown: true,
  });
}
...
export function validateCheckStock(data) {
  return checkStockSchema.validate(data, {
    abortEarly: false,
    stripUnknown: true,
  });
}
