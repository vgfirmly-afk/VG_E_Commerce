...
describe("Inventory Handlers", () => {
  ...
  describe("getStock", () => {
    ...
    it("should return 400 for invalid SKU ID", async () => {
      const request = createMockRequest("GET", "https://example.com/api/v1/stock/", null, {}, { sku_id: "" });
      const response = await handlers.getStock(request, env);
      const data = await response.json();
  ...
  describe("initializeStock", () => {
    ...
    it("should return 400 for invalid SKU ID", async () => {
      const request = createMockRequest("POST", "https://example.com/api/v1/stock/", {}, {}, { sku_id: "" });
      const response = await handlers.initializeStock(request, env);
      const data = await response.json();
  ...
  describe("updateStock", () => {
    ...
    it("should return 400 for invalid SKU ID", async () => {
      const request = createMockRequest("PUT", "https://example.com/api/v1/stock/", {}, {}, { sku_id: "" });
      const response = await handlers.updateStock(request, env);
      const data = await response.json();
  ...
  describe("reserveStock", () => {
    it("should reserve stock successfully", async () => {
      ...
      const request = createMockRequest("POST", "https://example.com/api/v1/stock/sku-1/reserve", body, {}, { sku_id: "sku-1" });
      request.user = { userId: "user-1" };
  ...
  describe("releaseStock", () => {
    it("should release stock successfully", async () => {
      ...
      const request = createMockRequest("POST", "https://example.com/api/v1/stock/sku-1/release", body, {}, { sku_id: "sku-1" });
      request.user = { userId: "user-1" };
  ...
  describe("getHistory", () => {
    it("should return stock history", async () => {
      ...
      const request = createMockRequest("GET", "https://example.com/api/v1/stock/sku-1/history?page=1&limit=20", null, {}, { sku_id: "sku-1" });
  ...
  describe("getProductStock", () => {
    ...
    it("should return 400 when product_id is missing", async () => {
      const request = createMockRequest("GET", "https://example.com/api/v1/stock/product/", null, {}, { product_id: "" });
      const response = await handlers.getProductStock(request, env);
      const data = await response.json();
  ...
  describe("checkAvailability", () => {
    it("should check availability for multiple SKUs", async () => {
      ...
      const mockDb = env.INVENTORY_DB;
      const mockStocks = [
        { sku_id: "sku-1", available_quantity: 90, quantity: 100, reserved_quantity: 10, status: "active" },
        { sku_id: "sku-2", available_quantity: 0, quantity: 0, reserved_quantity: 0, status: "out_of_stock" },
      ];
      mockDb.prepare().bind().all.resolves({ results: mockStocks });
  ...
  describe("Error handling edge cases", () => {
    ...
    it("should handle JSON parse errors in reserveStock", async () => {
      const request = createMockRequest("POST", "https://example.com/api/v1/stock/sku-1/reserve", null, {}, { sku_id: "sku-1" });
      request.json = async () => {
        throw new Error("Invalid JSON");
      };
    ...
    it("should handle JSON parse errors in releaseStock", async () => {
      const request = createMockRequest("POST", "https://example.com/api/v1/stock/sku-1/release", null, {}, { sku_id: "sku-1" });
      request.json = async () => {
        throw new Error("Invalid JSON");
      };
