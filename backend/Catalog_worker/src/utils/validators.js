...
const jsonField = Joi.alternatives()
...
export const productSchema = Joi.object({
  ...
  stock_status: Joi.string()
    .valid("in_stock", "out_of_stock", "backorder", "preorder")
    .allow(null, ""),
  ...
  product_type: Joi.string()
    .valid("simple", "variable", "grouped", "external")
    .default("simple"),
  ...
  tax_status: Joi.string()
    .valid("taxable", "shipping", "none")
    .default("taxable"),
  ...
  // Backward compatibility
  grouped_products: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),
  upsell_ids: Joi.alternatives().try(Joi.array(), Joi.string()).allow(null, ""),
  cross_sell_ids: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),
  related_products: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),
  accessories: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),
  replacement_parts: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),

  product_images: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),
  image_url: Joi.string().uri().allow(null, ""),
  image_alt: Joi.string().max(500).allow(null, ""),
  gallery_images: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),
  ...
  downloadable_files: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),
  ...
  included_items: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),
  ...
  video_tutorials: Joi.alternatives()
    .try(Joi.array(), Joi.string())
    .allow(null, ""),
...
export const imageIdSchema = Joi.string().min(1).max(100).required().messages({
...
export const skuAttributesSchema = Joi.object()
  .pattern(
    Joi.string(),
...
export function validateSku(data) {
  const result = skuSchema.validate(data, {
    abortEarly: false,
    stripUnknown: true,
  });
...
export function validateProductsQuery(params) {
  return productsQuerySchema.validate(params, {
    abortEarly: false,
    stripUnknown: true,
  });
}
...
export function validateSearchQuery(params) {
  return searchQuerySchema.validate(params, {
    abortEarly: false,
    stripUnknown: true,
  });
}
...
export function validateHomePageQuery(params) {
  return homePageQuerySchema.validate(params, {
    abortEarly: false,
    stripUnknown: true,
  });
}
...
export function validateSkuAttributes(attributes) {
  ...
  if (typeof attributes === "string") {
    try {
      ...
      return {
        error: { details: [{ message: "Invalid JSON in attributes field" }] },
        value: null,
      };
    }
  }
  return skuAttributesSchema.validate(attrs || {}, {
    abortEarly: false,
    stripUnknown: false,
  });
}
