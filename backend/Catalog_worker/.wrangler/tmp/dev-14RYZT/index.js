...
// .wrangler/tmp/bundle-QSdTYh/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-QSdTYh/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
function consolidateProductFields(product) {
  ...
  const parseJson = /* @__PURE__ */ __name((val) => {
    if (!val) return val;
  ...
  if (!consolidated.metadata) {
    const metadata = {};
    if (consolidated.mpn || consolidated.upc || consolidated.ean || consolidated.isbn || consolidated.gtin || consolidated.model_number || consolidated.sku) {
    ...
    if (consolidated.brand) {
      metadata.brand = consolidated.brand;
      delete consolidated.brand;
    }
    if (consolidated.manufacturer) {
      metadata.manufacturer = consolidated.manufacturer;
      delete consolidated.manufacturer;
    }
    if (consolidated.default_sku) {
      metadata.default_sku = consolidated.default_sku;
      delete consolidated.default_sku;
    }
    if (consolidated.category) {
      metadata.category = consolidated.category;
      delete consolidated.category;
    }
    if (consolidated.subcategory) {
      metadata.subcategory = consolidated.subcategory;
      delete consolidated.subcategory;
    }
    if (consolidated.categories) {
      metadata.categories = parseJson(consolidated.categories);
      delete consolidated.categories;
    }
    if (consolidated.tags) {
      metadata.tags = parseJson(consolidated.tags);
      delete consolidated.tags;
    }
  ...
  if (!consolidated.attributes) {
    const attributes = {};
    if (consolidated.weight || consolidated.length || consolidated.width || consolidated.height || consolidated.shipping_weight || consolidated.shipping_class) {
  ...
  if (!consolidated.inventory && (consolidated.stock_status || consolidated.stock_quantity !== void 0 || consolidated.low_stock_threshold !== void 0 || consolidated.manage_stock !== void 0 || consolidated.allow_backorders !== void 0 || consolidated.backorder_status || consolidated.package_quantity !== void 0 || consolidated.min_order_quantity !== void 0 || consolidated.max_order_quantity !== void 0)) {
    ...
    [
      ...
      "min_order_quantity",
      "max_order_quantity"
    ].forEach((f) => delete consolidated[f]);
  ...
  if (!consolidated.policies && (consolidated.warranty_period || consolidated.warranty_type || consolidated.return_policy || consolidated.purchase_note)) {
  ...
  if (!consolidated.seo && (consolidated.meta_title || consolidated.meta_description || consolidated.meta_keywords || consolidated.permalink || consolidated.canonical_url)) {
  ...
  if (!consolidated.stats && (consolidated.rating_average !== void 0 || consolidated.rating_count !== void 0 || consolidated.review_count !== void 0 || consolidated.view_count !== void 0 || consolidated.sales_count !== void 0 || consolidated.wishlist_count !== void 0 || consolidated.compare_count !== void 0 || consolidated.download_count !== void 0 || consolidated.total_sales !== void 0 || consolidated.average_rating !== void 0)) {
  ...
  if (!consolidated.flags && (consolidated.product_type || consolidated.virtual_product !== void 0 || consolidated.downloadable_product !== void 0 || consolidated.external_product !== void 0 || consolidated.requires_shipping !== void 0 || consolidated.taxable !== void 0 || consolidated.tax_class || consolidated.tax_status || consolidated.shipping_required !== void 0 || consolidated.shipping_taxable !== void 0 || consolidated.reviews_allowed !== void 0 || consolidated.sold_individually !== void 0 || consolidated.purchase_only !== void 0 || consolidated.catalog_visibility)) {
  ...
  if (!consolidated.relationships && (consolidated.parent_id || consolidated.menu_order !== void 0 || consolidated.grouped_products || consolidated.upsell_ids || consolidated.cross_sell_ids || consolidated.related_products || consolidated.accessories || consolidated.replacement_parts)) {
  ...
  if (!consolidated.media && (consolidated.product_images || consolidated.image_url || consolidated.image_alt || consolidated.gallery_images || consolidated.video_url || consolidated.video_embed || consolidated.downloadable_files || consolidated.download_limit !== void 0 || consolidated.download_expiry !== void 0)) {
  ...
  if (!consolidated.variants && (consolidated.product_attributes || consolidated.default_attributes || consolidated.variations || consolidated.variation_data || consolidated.variant_data)) {
...
__name(consolidateProductFields, "consolidateProductFields");
...
async function createProduct(product, env2) {
  try {
    ...
    if (!consolidated.created_at) consolidated.created_at = (/* @__PURE__ */ new Date()).toISOString();
    if (!consolidated.updated_at) consolidated.updated_at = (/* @__PURE__ */ new Date()).toISOString();
...
async function updateProduct(productId, updates, env2) {
  try {
    ...
    if (setFields.length === 0) return await getProductById(productId, env2);
...
async function updateSku(skuId, updates, env2) {
  try {
    const fields = Object.keys(updates);
    if (fields.length === 0) return null;
    ...
    values.push((/* @__PURE__ */ new Date()).toISOString(), skuId);
...
var jsonField = import_joi.default.alternatives().try(import_joi.default.object(), import_joi.default.string()).allow(null, "");
var productSchema = import_joi.default.object({
  ...
  skus: import_joi.default.array().items(import_joi.default.object({
...
var productIdSchema = import_joi.default.string().min(1).max(100).required().messages({
  "string.empty": "Product ID is required",
  "any.required": "Product ID is required"
});
var imageIdSchema = import_joi.default.string().min(1).max(100).required().messages({
...
var productsQuerySchema = import_joi.default.object({
  q: import_joi.default.string().max(500).allow(""),
  category: import_joi.default.string().max(200).allow(""),
...
var searchQuerySchema = import_joi.default.object({
  q: import_joi.default.string().min(1).max(500).required().messages({
...
var homePageQuerySchema = import_joi.default.object({
  categories: import_joi.default.string().max(1e3).allow(""),
  // Comma-separated list
  limit: import_joi.default.number().integer().min(1).max(100).default(10)
});
var skuAttributesSchema = import_joi.default.object().pattern(
  import_joi.default.string(),
  import_joi.default.alternatives().try(
    import_joi.default.string(),
    import_joi.default.number(),
    import_joi.default.boolean(),
    import_joi.default.array(),
...
__name(validateSkuAttributes, "validateSkuAttributes");
...
async function getHomePage(request, env2) {
  try {
    ...
    const { error: error3, value } = validateHomePageQuery(queryParams);
    if (error3) {
      return new Response(
        JSON.stringify({
          error: "validation_error",
    ...
    const categories = value.categories ? value.categories.split(",").map((c) => c.trim()).filter((c) => c.length > 0) : ["Electronics", "Toys", "Dress", "Books", "Sports"];
    const products = await getHomePageProducts(categories, value.limit, env2);
    return new Response(
...
async function searchProductsHandler(request, env2) {
  try {
    ...
    const { error: error3, value } = validateSearchQuery(queryParams);
    if (error3) {
      return new Response(
        JSON.stringify({
          error: "validation_error",
    ...
    const products = await listProducts({ q: value.q, category: value.category, page: value.page, limit: value.limit }, env2);
    return new Response(
      JSON.stringify({
        products: products.map((p) => ({
          product_id: p.product_id,
...
async function createProductService(productData, userId, env2) {
  try {
    ...
    await createProduct(product, env2);
...
async function updateSkuService(skuId, updates, productId, env2) {
  try {
    const preparedUpdates = {
      ...updates,
      updated_at: (/* @__PURE__ */ new Date()).toISOString()
    };
    await updateSku(skuId, preparedUpdates, env2);
    await invalidateProductCache(productId, env2);
...
__name(updateSkuService, "updateSkuService");
async function deleteSkuService(skuId, productId, env2) {
  try {
    await deleteSku(skuId, env2);
    await invalidateProductCache(productId, env2);
...
__name(deleteSkuService, "deleteSkuService");
async function uploadProductImageService(productId, imageId, imageFile, env2) {
  try {
    if (!env2.CATALOG_IMG_BUCKET) {
      throw new Error("R2 bucket not configured");
    }
    const r2Path = `products/${productId}/${imageId}.jpg`;
    await env2.CATALOG_IMG_BUCKET.put(r2Path, imageFile, {
      httpMetadata: {
...
__name(uploadProductImageService, "uploadProductImageService");
...
async function createSku2(request, env2) {
  try {
    const productId = request.params?.product_id;
    const { error: idError } = validateProductId(productId);
    if (idError) {
    ...
    const { error: error3, value } = validateSku(skuData);
    if (error3) {
      return new Response(
        JSON.stringify({
          error: "validation_error",
    ...
    const userId = request.user?.userId || "system";
    const sku = await createSkuService(value, userId, env2);
    return new Response(
      JSON.stringify(sku),
      { status: 201, headers: { "Content-Type": "application/json" } }
    );
...
__name(createSku2, "createSku");
async function updateSku2(request, env2) {
  try {
    const productId = request.params?.product_id;
    ...
    const body = await request.json();
    const { error: error3, value } = validateSku(body);
    if (error3) {
      return new Response(
        JSON.stringify({
          error: "validation_error",
    ...
    await updateSkuService(skuId, value, productId, env2);
    return new Response(
...
__name(updateSku2, "updateSku");
async function deleteSku2(request, env2) {
  try {
    const productId = request.params?.product_id;
    const skuId = request.params?.sku_id;
    const { error: productIdError } = validateProductId(productId);
    ...
    await deleteSkuService(skuId, productId, env2);
    return new Response(
...
__name(deleteSku2, "deleteSku");
async function uploadProductImage(request, env2) {
  try {
    const productId = request.params?.product_id;
    const { error: idError } = validateProductId(productId);
    if (idError) {
    ...
    const imageId = formData.get("image_id") || v4_default();
    if (!imageFile) {
      return new Response(
        JSON.stringify({
          error: "validation_error",
    ...
    const result = await uploadProductImageService(
      productId,
      imageId,
...
router.post(
  ...
  async (request, env2, ctx) => {
    ...
    return createSku2(request, request.env || env2);
  }
);
router.put(
  ...
  async (request, env2, ctx) => {
    ...
    return updateSku2(request, request.env || env2);
  }
);
router.delete(
  "/api/v1/products/:product_id/skus/:sku_id",
  async (request, env2, ctx) => {
    ...
    return deleteSku2(request, request.env || env2);
  }
);
router.post(
  ...
  async (request, env2, ctx) => {
    ...
    return uploadProductImage(request, request.env || env2);
  }
);
