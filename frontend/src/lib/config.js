...
export const API_BASE_URLS = {
  ...
  CART:
    import.meta.env.VITE_CART_BASE_URL ||
    "https://w2-cart-worker.vg-firmly.workers.dev",
  CHECKOUT:
    import.meta.env.VITE_CHECKOUT_BASE_URL ||
    "https://w2-checkout-worker.vg-firmly.workers.dev",
  PAYMENT:
    import.meta.env.VITE_PAYMENT_BASE_URL ||
    "https://w2-payment-worker.vg-firmly.workers.dev",
  PRICING:
    import.meta.env.VITE_PRICING_BASE_URL ||
    "https://w2-pricing-worker.vg-firmly.workers.dev",
  INVENTORY:
    import.meta.env.VITE_INVENTORY_BASE_URL ||
